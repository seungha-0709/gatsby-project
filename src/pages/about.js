      ...
      <div className="post-container" style={{ position: 'relative' }}>
        <div className="post-wrapper">
          ...
          <P>
            ...
            그러다 어쩌다 저쩌다 제가 쓴 일기를 저의 정신과 주치의 선생님께 보여드릴 필요성을 느끼게 되어, 잠시 이 블로그를 전부 비공개로 닫아두고, 제가 손으로 쓴 일기들을 여기에 타이핑헤 옮겨둔 뒤 오직 의사선생님만 볼 수 있게 닫아 놓았습니다.
          </P>
          <P>
            지금은 이 블로그를 공개로 열어둔 상태입니다. 아직 검색엔진에 잡힐 수 있도록까지는 작업하지 않았지만, 아무튼 그렇습니다. 원래는 개발 공부 기록하려고 만든 사이트인데 앞으로도 쭉 여기에는 저의 일상 일기가 올라갈 것 같습니다.
          </P>
          <P>이상 블로그 소개 끝.</P>
          <hr />
